...
export default class ListItem extends React.Component {
  ...
  render() {
    ...
    let dataUIElements = props.data.map(item => {
      return (
        <View style={styles.itemThreeMetaContainer}>
          <View style={{flex:1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 3}}>
    ...
    return (
      <TouchableOpacity onPress={props.onPress} activeOpacity={props.onPress ? 0.2 : 1}> 
